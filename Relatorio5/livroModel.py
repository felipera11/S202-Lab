...
class LivroModel:
    ...
    def create_livro(self, id:int, titulo: str, autor: str, ano:int, preco:float):
        try:
    ...
    def read_livro_by_id(self, id: int):
        try:
    ...
    def update_livro(self, id: int, titulo: str, autor: str, ano:int, preco:float):
        try:
